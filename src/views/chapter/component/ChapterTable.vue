      ...
      >
        ...
        <td class="actions-cell flex">
          <div
            ...
            no-wrap
          >
            <router-link :to="{ name: 'chapterEdit', params: { comicId: $route.params.comicId, chapterId: item.id }}">
              <button class="bg-green-500 hover:bg-green-700 text-white text-sm font-bold py-2 px-4 rounded">
                Edit
              </button>
            </router-link>

            <router-link :to="{ name: 'pageList', params: { comicId: $route.params.comicId, chapterId: item.id }}">
              <button class="mx-2 bg-blue-500 hover:bg-blue-700 text-white text-sm font-bold py-2 px-4 rounded">
                pages
              </button>
            </router-link>
